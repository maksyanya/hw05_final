...
SECRET_KEY = 'e0s8kzwsq=j&zx!wrin2rscqpwb=b^wj$civl)-8oyz44-94ww'
...
INSTALLED_APPS = [
    ...
    'users.apps.UsersConfig',  # Зарегистрировано users
    'core.apps.CoreConfig',    # Зарегистрировано core
    'about.apps.AboutConfig',  # Зарегистрировано about
